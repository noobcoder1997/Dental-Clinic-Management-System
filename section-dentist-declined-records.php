        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-body">
                        <table id="dentist-declined-patient-record-table" class="table table-borderless table-hover">
                            <thead>
                            <tr>
                            ...
                            while($row0 = $result0->fetch_array(MYSQLI_ASSOC)){
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#dentist-view-declined-patient-modal<?php echo $row0['appointment_id']; ?>"><span class="fa fa-eye fa-fw"></span></button>
                                            <div class="modal fade" id="dentist-view-declined-patient-modal<?php echo $row0['appointment_id']; ?>" data-keyboard="false" data-backdrop="static">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer ">
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="dentistAcceptAppointment_(<?php echo $row0['appointment_id']; ?>)">Accept</button>
                                                        <script>
                                                            function dentistAcceptAppointment_(id){
                                                                form = new FormData();
                                                                form.append('id', id);
...
<script>
  $(document).ready( function(){
        $(function () {
            $("#dentist-declined-patient-record-table").DataTable({
            "responsive": true,
            "lengthChange": true, 
            "autoWidth": true,
            // "pageLength": 50,
