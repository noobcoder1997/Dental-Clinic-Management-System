...
<section class="content">
    ...
    <?php
        ...
        ?>
            ...
            <div class="col-sm-12">
                <div class="card mt-3">
                <div class="card-header"><h4>Set an Appointment</h4></div>
                <div class="card-body">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="patient-set-appointment" role="form" enctype="multipart/form-data">
                                <div class="row">
                                    <?php
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="row" id="t-row" style="display: none;">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <button href="" class="btn btn-secondary float-right" type="submit" name="submit-patient-appointment" data-dismiss="modal" >Set Appointment</button>
                                                                <script>
                                                                    $('#patient-set-appointment').on('submit', function(e){
                                                                        e.preventDefault();
