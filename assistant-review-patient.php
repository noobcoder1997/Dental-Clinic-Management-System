...
<div class="table-responsive">
    <table id="assistant-view-patient-appointments-table" class="table table-borderless table-hover">
        <thead>
            <tr>
...
<button type="button" class="btn btn-default float-right" onclick="assistantBacktoForm()">Close</button>
<script>
