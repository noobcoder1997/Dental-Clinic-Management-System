    ...
    <div class="row">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h4 class="">Approved Appointments</h4>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row float-right">
                                <!-- <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#assistant-add-service-modal">Add Appointment</button> -->
                                <!-- Add Modal -->
                                <div class="modal fade" id="assistant-add-service-modal" data-keyboard="false" data-backdrop="static">
                                    ...
                                    <div class="modal-content">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="number" name="" id="service-price">
                                                    </div>
                                                    <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="_addService()">Add Service</button>
                                        <!-- <script>
                                            function addService(){
                                                if($('#service-name').val() == '' || $('#service-price').val() == '' || $('#service-desc').val() == ''){
                                                    alert('Fields should not leave empty.');
                                                }else{
                                                    form = new FormData();
                                                    form.append('name', $('#service-name').val());
                                                    form.append('price', $('#service-price').val());
                                                    form.append('description', $('#service-desc').val());
                                                    $.ajax({
                                                        url: "assistant-add-services.php",
                                                        type: "POST",
                                                        data: form,
                                                        processData: false,
                                                        contentType: false,
                                                        ...
                                                        alert(data);
                                                        $("#assistant-add-service-modal").modal('hide');
                                                        $('.modal-backdrop').remove();
                                                        $("#assistant-add-service-modal").trigger('reset');
                                                        addassistantService();
                                                    })
                                                }
                                            }
                                    ...
                                    <!-- /.modal-dialog -->
                                        ...
                                        $(document).ready( function(){
                                            $(document).ready(function() {
                                                $("#assistant-add-service-modal").on("hidden.bs.modal", function() {
                                                $("#assistant-add-service-modal input").val('');
                                                $("#assistant-add-service-modal textarea").val('');
                                                });
                                            });
                                        })
                                        </script> -->
                        ...
                        <div class="card-body" id="approved-apoointment-body">
                            <table id="assistant-view-patient-record-table" class="table table-borderless table-hover">
                                <thead>
                                <tr>
                                ...
                                $stmt0->bind_param("ss",$status, $designation);
                                $stmt0->execute();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="assistant-view-appointment-modal<?php echo $row0['appointment_id']; ?>" data-keyboard="false" data-backdrop="static">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-secodary">
                                                        <h4 class="modal-title">View Patient Record</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" value="<?php echo $appointment_date; ?>" readonly id="date"><br>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                        ...
                                                        <div class="modal-footer ">
                                                            ...
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="assistantAppointmentProceedBilling(<?php echo $row0['appointment_id']; ?>)">Add to Billing</button>
                                                            <script>
                                                                function assistantAppointmentProceedBilling(id){
                                                                    form = new FormData();
                                                                    form.append('id', id);
                                                                    form.append('date', $('#date').val());
                                                                    $.ajax({
                                                                        url: "assistant-proceed-billing.php",
                                                                        type: "POST",
                                                                        data: form,
                                                                        processData: false,
                                                                        contentType: false, 
                                                                        ...
                                                                        alert(data);
                                                                        if(data == "Patient was already moved to billing!"){
                                            ...
                                            <td>
                                                <span class="status badge bg-success" style="text-align: center;">
