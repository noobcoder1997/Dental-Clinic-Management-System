...
<!-- View basic Info of Patient Modal -->
    ...
    <div class="modal fade" id="as-show-patient-modal<?php echo $id ?>" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Set Patient Appointment</h4>
            ...
            <div class="modal-body">
                ...
                <section class="patient-info">
                    ...
                    ?>
                    <button type="button" class="btn btn-primary float-right" onclick="slideUpForm()">Set an Appointment</button>
                </section>
                ...
                <section class="content show-appontment" style="display: none;">
                    ...
                    <div class="row mt-3">
                            ...
                            <div class="col-sm-12">
                                <form id="assistant-patient-set-appointment-form" role="form" enctype="multipart/form-data">
                                    <div class="row">
                                        <?php
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="row" id="t-row" style="display: none;">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <script>
                                                                        $('#assistant-patient-set-appointment-form').on('submit', function(e){
                                                                            e.preventDefault();
...
<script>
    ...
    function patientSelectServices(){
        $.ajax({
