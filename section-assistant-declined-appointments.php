    ...
    <div class="row">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h4 class="">Declined Appointments</h4>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-body" id="declined-appointment-body">
                        <table id="assistant-declined-patient-record-table" class="table table-borderless table-hover">
                            <thead>
                            <tr>
                            ...
                            while($row0 = $result0->fetch_array(MYSQLI_ASSOC)){
                                $appointment_date = strtotime($row0['appointment_date']);
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#assistant-view-declined-patient-modal<?php echo $row0['appointment_id']; ?>"><span class="fa fa-eye fa-fw"></span></button>
                                            <div class="modal fade" id="assistant-view-declined-patient-modal<?php echo $row0['appointment_id']; ?>" data-keyboard="false" data-backdrop="static">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer ">
                                                        ...
                                                        <button type="button" class="btn btn-primary" onclick="assistantAcceptAppointment_(<?php echo $row0['appointment_id']; ?>)">Accept</button>
                                                        <script>
                                        ...
                                        <td>
                                            <span class="status badge bg-danger" style="text-align: center;">
...
<script>
  $(document).ready( function(){
        $(function () {
            $("#assistant-declined-patient-record-table").DataTable({
            "responsive": true,
            "lengthChange": true, 
            "autoWidth": true,
            // "pageLength": 50,
