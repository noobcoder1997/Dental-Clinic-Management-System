                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-primary btn-xs" onclick="showEditModal(<?php echo $row0['appointment_id']; ?>)" ><span class="fa fa-edit fa-fw"></span></button>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div id="display-edit-date<?php echo $row0['appointment_id']; ?>">
                                                                                    <input type="text" class="form-control" id="edit-datepicker" value="<?php echo $appointment_date; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-4">
                                            ...
                                            <script>
                                                function showEditModal(id){
                                                    ...
                                                    $.ajax({
                                                        data: 'dentist='+$('#dentist-id').val()+'&branch='+$('#branch-id').val()+'&date='+$('#edit-datepicker').val()+"&id="+id,
                                                        type: 'POST',
